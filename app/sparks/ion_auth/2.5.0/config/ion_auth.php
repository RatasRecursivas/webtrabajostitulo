 ...
 */
$config['site_title']                 = "Portal Trabajos de titulo UTEM";       // Site Title, example.com
$config['admin_email']                = "noresponder@informatica.utem.cl"; // Admin Email, admin@example.com
